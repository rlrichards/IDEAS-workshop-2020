...
# Lastly we can subset rows of our data based on specific metadata using the `subset()` function
# Note that this is analogous to the `filter()` function from the tidyverse before
# Let's make a new data frame showing only data for ID's that "Passed"
df_passed <- subset(df, Passed == TRUE)
