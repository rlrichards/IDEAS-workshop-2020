...
In this third part, you will work in a small group to produce a new plot using the midwest dataset or any other data set we've introduced so far.
...
Remember, a good place to start is with View(midwest) or str(midwest) to see what type of data are available. 
